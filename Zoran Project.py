...
g1.fig.suptitle("Meta score distribution per company", y=0.99, color="darkred",)
...
g2.set_title("Average meta score per company 1995.-2021.", y=1.05, color="darkred",)
...
g4.set_title("Average user review per company 1995.-2021.", y=1.05, color="darkred",)
...
g5.fig.suptitle("Meta score per platform", color="darkred", y=0.98)
...
g8.set_title("Corelation heatmap", color="darkred", y=1.05)
